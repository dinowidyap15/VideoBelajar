  ...
  return (
    <>
      <section className="flex flex-col justify-between max-w-full mx-auto xl:pt-16 lg:pt-14 md:pt-12 pt-8 xl:px-32 lg:px-20 md:px-16 px-6 bg-bg-main">
        <p className="flex flex-row font-lato text-md text-dark-2 mb-10">
          <RouterLink to="/home" smooth={true} duration={10} className={`font-lato text-md text-dark-2 cursor-pointer`}>
            Beranda
          </RouterLink>
          <span className="mx-2">/</span>
          <RouterLink to="/category" smooth={true} duration={10} className={`font-lato text-md text-dark-2 cursor-pointer`}>
            {product.category}
          </RouterLink>
          <span className="mx-2">/</span>
          <p className="font-lato text-md text-dark-1 cursor-pointer truncate sm:whitespace-normal">{product.title}</p>
        </p>
        ...
        <div className="relative w-full h-96 overflow-hidden rounded-xl">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start lg:px-24 md:px-10 sm:px-8 px-4 lg:py-12 md:py-10 sm:py-8 py-6 md:gap-4 gap-2 z-20">
            ...
            <p className="font-lato text-xs sm:text-sm text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 sm:gap-8 my-8">
          <div className="flex flex-col lg:order-last self-start gap-4 border mb-8 border-bg-border rounded-xl bg-white p-4">
            ...
            <p className="font-poppins font-semibold text-lg text-primary-400">Rp{product.price},00</p>
            <p className="font-lato font-semibold text-info-default md:text-md sm:text-sm text-xs mb-2">Penawaran spesial tersisa 2 hari lagi!</p>
            ...
            <p className="font-lato font-semibold text-dark-1 md:text-md sm:text-sm text-xs mt-2">Kelas Ini Sudah Termasuk</p>
            <div className="flex flex-col gap-4">
              <div className="flex flex-row gap-2">
                ...
                <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs mr-10">Ujian Akhir</p>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                ...
                <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs">49 video</p>
              </div>
              <div className="flex flex-row gap-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs mr-10">7 Dokumen</p>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs">Sertifikat</p>
              </div>
              <div className="flex flex-row gap-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                ...
                <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs">Pretest</p>
              </div>
            </div>

            <p className="font-lato font-semibold text-dark-1 md:text-md sm:text-sm text-xs">Bahasa Pengantar</p>
            <div className="flex flex-row gap-2">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs">Bahasa Indonesia</p>
            </div>
          </div>

          <div className="flex flex-col col-span-2 gap-8">
            <div className="flex flex-col gap-4 border border-bg-border rounded-xl bg-white p-4">
              <h3 className="font-poppins font-semibold md:text-lg text-md text-dark-1">Deskripsi</h3>
              <p className="font-lato text-dark-2 md:text-md sm:text-sm text-xs">{product.description}</p>
            </div>
            ...
            <div className="col-span-1 md:col-span-2 w-full flex flex-col gap-4 border border-bg-border rounded-xl bg-white p-4">
              ...
              <div className="flex md:flex-row flex-col justify-between gap-4">
                <div className="overflow-hidden w-full border border-bg-border rounded-xl bg-white flex flex-col items-start relative p-4 gap-4">
                  ...
                  <p className="font-lato text-dark-1 md:text-md sm:text-sm text-xs">
            ...
            <div className="col-span-1 md:col-span-2 w-full flex flex-col gap-4 border border-bg-border rounded-xl bg-white p-4">
              ...
              <div className="flex flex-row gap-2 justify-between cursor-pointer" onClick={toggleSection}>
